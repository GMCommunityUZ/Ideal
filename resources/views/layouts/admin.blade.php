...
<head>
	...
	<link rel="icon" href="/consImages/logoU.jpg ">
</head>
...
<div class="wrapper" style="display: block">
					...
					<li>
						@if(auth()->user())
                            <a href="{{ route('userEdit',auth()->user()->id) }}" class="dropdown-item">
                                <i class="fas fa-cogs"></i> Sozlamlar
                            </a>
                        @endif
					</li>
					<li>
	...
	<aside class="main-sidebar elevation-1 {{ auth()->user()->theme()['sidebar'] ?? 'sidebar-dark-primary' }}">
		...
		<a href="#" class="brand-link">
			<img src="{{ asset('consImages/logoU.jpg') }}" alt="Unired Logo" class="brand-image img-circle elevation-3"
				 style="opacity: .8">
			<span class="brand-text font-weight-light">Ideal o'quv markazi</span>
		</a>
...
<script src="{{asset('plugins/exel/exel.js')}}"></script>
