            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ isset($item) ? url('graphics/'.$id.'/month/'.$item) : route('graphicStudents', $id) }}">O'quvchilar ro'yxati</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('graphicCreate') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ isset($item)? url('graphics/'.$id.'/month/'.$item) : route('graphicStudents', $id) }}" class="btn btn-default float-left">Orqaga</a>
                            </div>
                        </form>
                    </div>
                </div>
