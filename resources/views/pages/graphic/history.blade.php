                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table  class="table table-bordered table-striped table-responsive-lg" role="grid" aria-describedby="dataTable_info">
                            <thead>
                            <form action="{{route('graphicHistory')}}" method="get">
                                <tr>
                                    <td></td>
                                    <td colspan="2">
                                    ...
                                    <td>
                                        <input class="form-control" type="month" name="month" value="{{old('Y-m' , request()->month)}}">
                                    </td>
                                    <td colspan="2">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="{{route('graphicHistory')}}" class="btn btn-default btn-sm"><i class="fas fa-recycle"></i> Tozalash</a>
                                        </div>
                                    </td>
                                </tr>
                            </form>
