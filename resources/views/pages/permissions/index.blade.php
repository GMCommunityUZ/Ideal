...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Ruxsatlar boshqaruvi</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Bosh sahifa</a></li>
                        <li class="breadcrumb-item active">Ruxsatlar boshqaruvi</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('permissionDestroy',$permission->id) }}" method="post">
                                            ...
                                            <div class="btn-group">
                                                @can('permission.edit')
                                                    <a href="{{ route('permissionEdit',$permission->id) }}" type="button" class="btn btn-info btn-sm"> <i class="fas fa-edit"></i></a>
                                                @endcan
