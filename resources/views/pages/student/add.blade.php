                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('studentCreate') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 {{ $errors->has('group_id') ? "is-invalid":"" }}"  name="group_id" data-placeholder="@lang('pleaseSelect')" style="width: 100%;">
                                        ...
                                        @foreach($groups as $group)
                                            <option value="{{ $group->id }}">{{ $group->name }} | {{$group->teacher->name}} | {{$group->teacher->course}}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_2" class="form-control {{ $errors->has('phone_2') ? "is-invalid":"" }}" value="{{ old('phone_2') }}" >
